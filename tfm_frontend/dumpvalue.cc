...
//-----------------------------------------------------------------------------
static void dumpBool(const char *   const prefix, xmlrpc_value * const valueP) {
...
static void dumpDouble(const char *   const prefix, xmlrpc_value * const valueP) {
...
//-----------------------------------------------------------------------------
static void dumpDatetime(const char *   const prefix, xmlrpc_value * const valueP) {
