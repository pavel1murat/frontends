...
bool stripcaseeq(const char* comparand, const char* comparator);

static const char* strippedSubstring(const char * const string) {
    const char * p;
...
//-----------------------------------------------------------------------------
void interpretUll(const char *  const string,
                  uint64_t *    const ullP,
...
void interpretLl(const char *  const string,
                 int64_t *     const llP,
                 const char ** const errorP) {
...
void interpretUint(const char *   const string,
...
//-----------------------------------------------------------------------------
void interpretInt(const char *  const string,
                  int *         const intP,
                  const char ** const errorP) {
...
//-----------------------------------------------------------------------------
void interpretBinUint(const char *  const string,
  ...
  if (errno == ERANGE)
    ...
    *errorP = NULL;  /* initial assumption */
    ...
    if (!*errorP) {
      if (argNumber < 0) {
        casprintf(errorP, "Unsigned numeric value is negative: %li", argNumber);
      }
      else {
