...
class TestPeriodicEquipment(midas.frontend.EquipmentBase):
    """
    ...
    def readout_func(self):
        return None # event # None #  event

#------------------------------------------------------------------------------
# RPI assigned to a certain station
#------------------------------------------------------------------------------
class TestFrontend(midas.frontend.FrontendBase):
    """
...
#------------------------------------------------------------------------------
        ...
        self.add_equipment(TestPeriodicEquipment(self.client,self.name))

        self.cmd_top_path = '/Mu2e/Commands/Test/'+self.name;
