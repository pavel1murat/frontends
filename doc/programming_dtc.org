...
bitfile=/home/mu2ehwdev/DTC_Firmware/DTC2025Dec14_14_22.1_6ROC/DTC.bit
vivado_lab -mode batch -source /home/mu2ehwdev/ots_spack/srcs/otsdaq-mu2e/tools/program_both_DTCs.tcl -tclargs $bitfile $bitfile
...
#+end_src
- in MC2, that is done by a [sudoers] script which, under the hood, is doing essentially the same - remove and rescan
#+begin_src
