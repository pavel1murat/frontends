...
#+end_src
** using mu2ehwdev script                                                    
- note extra shell level - w/o that, the script gets stuck, ... got stuck with one parameter as well
- in all cases, need to reset the PCIE bus         
#+begin_src                                                                  
...
** as root                                                                   
#+begin_src
root@mu2exxxx:>lspci | grep Xilinx
...
#+end_src
** in MC2 (user mode, sudoers                                                
- the [sudoers] script under the hood is doing essentially the same - remove and rescan
#+begin_src
