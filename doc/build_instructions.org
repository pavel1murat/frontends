...
#+end_src
# add CPU target to the $spack_env/spack.yaml, also use system-wide krb5, openssl, and opengl
#+begin_src
spack:
  packages:
    all:
...
#+end_src
# ------------------------------------------------------------------------------
# or this should also work - better instead
# ------------------------------------------------------------------------------
#+begin_src
...
spack add artdaq-daqinterface            # need mopup_shmem
...
spack add     geant4@11.3.2   cxxstd=20
spack add     Offline@develop cxxstd=20
...
#                                  frontends depends on otsdaq-mu2e-tracker
