...
// DTC 
//-----------------------------------------------------------------------------
#ifndef __TTrkEquipmentNode_hh__
#define __TTrkEquipmentNode_hh__
...
class TTrkEquipmentNode : public TEquipmentNode {
  enum {
    kNRegHist    =  4,
    kNRegNonHist = 15,     
  } ;
...
// functions
//-----------------------------------------------------------------------------
  TTrkEquipmentNode(const char* eqname, const char* eqfilename);
  ...
  //  virtual TMFeResult InitDtc               ();
  // virtual void       InitDtcVarNames       ();
  // virtual void       ReadDtcMetrics        ();
