...
//-----------------------------------------------------------------------------
int TEqCalDtc::ClearStatus(HNDLE H_Cmd) { // std::ostream& Stream) {
  int rc(0);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::ConfigureJA(HNDLE H_Cmd) { // std::ostream& Stream) {
...
//-----------------------------------------------------------------------------
int TEqCalDtc::InitReadout(HNDLE H_Cmd) { // std::ostream& Stream) {
  int rc(0);
...
// HARD RESET
//-----------------------------------------------------------------------------
int TEqCalDtc::HardReset(HNDLE H_Cmd) {
  int rc(0);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::PrintRocStatus(HNDLE H_Cmd) {
  int rc(0);
...
// print DTC status
//-----------------------------------------------------------------------------
int TEqCalDtc::PrintStatus(HNDLE H_Cmd) {
  int rc(0);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::ReadRegister(HNDLE H_Cmd) {
  int rc(0);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::ReadRocRegister(HNDLE H_Cmd) {
  int rc(0);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::ReadSubevents(HNDLE H_Cmd) {
  int rc(0);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::ResetRoc(HNDLE H_Cmd) {
  int rc(0);
...
// SOFT RESET
//-----------------------------------------------------------------------------
int TEqCalDtc::SoftReset(HNDLE H_Cmd) {
  int rc(0);
...
// one line per link
//-----------------------------------------------------------------------------
int TEqCalDtc::StartMessage(HNDLE h_Cmd, std::stringstream& Stream) {
...
//-----------------------------------------------------------------------------
int TEqCalDtc::WriteRegister(HNDLE H_Cmd) { 
  int rc(0);
  TLOG(TLVL_DEBUG) << std::format("-- START");
  SetStatus(1);
...
//-----------------------------------------------------------------------------
int TEqCalDtc::WriteRocRegister(HNDLE H_Cmd) { // std::ostream& Stream) {
  int rc(0);
  TLOG(TLVL_DEBUG) << std::format("-- START:");
  SetStatus(1);
