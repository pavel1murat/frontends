...
//-----------------------------------------------------------------------------
void DtcInterfaceCrv::PrintRocRegister(uint32_t Reg, std::string& Desc, int Format, int LinkMask,std::ostream& Stream) {
...
//-----------------------------------------------------------------------------
void DtcInterfaceCrv::PrintRocRegister2(uint RegLo, uint RegHi, std::string& Desc, int Format, int LinkMask, std::ostream& Stream) {
...
//-----------------------------------------------------------------------------
int DtcInterfaceCrv::PrintRocStatus(uint32_t Format, int Link, std::ostream& Stream) {
  int rc(0);
